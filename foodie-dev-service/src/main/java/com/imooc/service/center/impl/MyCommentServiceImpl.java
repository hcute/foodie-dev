...
public class MyCommentServiceImpl extends BasicService implements MyCommentService {
    ...
    public void saveComments(String userId, String orderId, List<OrderItemsCommentBO> commentList) {
        // 1 保存评价
        for (OrderItemsCommentBO orderItemsComment : commentList) {
            orderItemsComment.setCommentId(sid.nextShort());
        }
    ...
    public PagedGridResult queryMyComments(String userId, Integer page, Integer pageSize) {
        ...
        PagedGridResult pagedGridResult = setterPagedGird(list, page);
